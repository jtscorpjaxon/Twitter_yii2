...
$list=\app\models\Posts::findAll(['user_id'=>Yii::$app->user->id]);
?>
    ...
    <div class="row">
        <div class="col profile-col">
            ...
            <div class="profile-header">
                <!-- Header information -->
                <h3 class="profile-fullname"><a><?= $user->first_name.' '.$user->last_name ?></a><a></a></h3><a>
                </a><h2 class="profile-element"><a></a><a>@<?= $user->username ?></a></h2>
